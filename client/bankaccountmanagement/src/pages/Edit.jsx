...
function Edit() {
    const [bookData, setBookData] = useState({
        id:'',name: '', place: '', email: '', phone: '', account_no: ''
    })
    ...
    const updateData = (e) => {
        ...
        const { name, place, email, phone, account_no } = bookData;
        if (!name || !place || !email || !phone || !account_no) {
            toast.error('Please fill all the fields');
        } 
        else {
            editBooking(bookData.id, { name, place, email, phone, account_no }).then((res) => {
                    ...
                    <div className="row d-flex align-items-center justify-content-center">
                        ...
                        <div className='col-md-7'>
                            <form action="">
                                ...
                                <FloatingLabel controlId="floatingSalary" label=" Enter your 12-digits account_no" className="mb-3">
                                    <Form.Control type="number" placeholder="account_no" value={bookData.account_no} onChange={(e) => setBookData({ ...bookData, account_no: e.target.value })} />
                                </FloatingLabel>
